    ...
    return (
        <div>
            ...
            rows={rows} paginator rowsPerPageOptions={[5, 10, 25, 50]} emptyMessage="Aucun compte fournisseur trouvé.">
                ...
                <Column field="fournisseur.telephone_fournisseur" header="Téléphone" sortable editor={(options) => textEditor(options)} filter></Column>
                <Column field="fournisseur.num_fournisseur" header="Numéro de fournisseur" sortable editor={(options) => textEditor(options)} filter></Column>
                <Column field="fournisseur.description" header="Description" sortable editor={(options) => textEditor(options)} filter></Column>
